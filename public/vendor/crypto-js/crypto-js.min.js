            ...
            _doProcessBlock: function (t, e) {
                for (
                    ...
                    var d = (i & o) ^ (i & n) ^ (o & n),
                        ...
                        i =
                            (u +
                                ((((i << 30) | (i >>> 2)) ^ ((i << 19) | (i >>> 13)) ^ ((i << 10) | (i >>> 22))) + d)) |
                            0;
                }
                ((r[0] = (r[0] + i) | 0),
                    (r[1] = (r[1] + o) | 0),
            ...
            (u = (w.kdf = {}).OpenSSL =
                {
                    execute: function (t, e, r, i, o) {
                        ((i = i || s.random(8)),
                            (o = (o ? a1.create({ keySize: e + r, hasher: o }) : a1.create({ keySize: e + r })).compute(
                                t,
                                i
                            )));
            ...
            _doCryptBlock: function (t, e, r, i, o, n, s, c) {
                for (
                    ...
                    var _ = i[h >>> 24] ^ o[(l >>> 16) & 255] ^ n[(f >>> 8) & 255] ^ s[255 & d] ^ r[u++],
                        ...
                        d = v;
                ((_ =
                    ((c[h >>> 24] << 24) | (c[(l >>> 16) & 255] << 16) | (c[(f >>> 8) & 255] << 8) | c[255 & d]) ^
                    r[u++]),
                    (y =
                        ((c[l >>> 24] << 24) | (c[(f >>> 16) & 255] << 16) | (c[(d >>> 8) & 255] << 8) | c[255 & h]) ^
                        r[u++]),
                    (g =
                        ((c[f >>> 24] << 24) | (c[(d >>> 16) & 255] << 16) | (c[(h >>> 8) & 255] << 8) | c[255 & l]) ^
                        r[u++]),
                    (v =
                        ((c[d >>> 24] << 24) | (c[(h >>> 16) & 255] << 16) | (c[(l >>> 8) & 255] << 8) | c[255 & f]) ^
                        r[u++]));
        ...
        (u = u.RabbitLegacy =
            p.extend({
                ...
                _doProcessBlock: function (t, e) {
                    ...
                    for (var i = 0; i < 4; i++)
                        ((h[i] =
                            (16711935 & ((h[i] << 8) | (h[i] >>> 24))) | (4278255360 & ((h[i] << 24) | (h[i] >>> 8)))),
                            (t[e + i] ^= h[i]));
                },
                blockSize: 4,
                ivSize: 2,
                    ...
                    if (this._keyPriorReset !== this._key) {
                            ...
                            t = t.sigBytes / 4;
                        {
                            ...
                            for (let t = 0; t < F + 2; t += 2)
                                ((o = R2(s, r, i)), (r = o.left), (i = o.right), (s.pbox[t] = r), (s.pbox[t + 1] = i));
                            for (let e = 0; e < 4; e++)
