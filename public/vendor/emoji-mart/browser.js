!(function () {
    ...
    function Y(e, t, r, n, o, i, a, s, c, l) {
        ...
        for (r.__k = [], u = 0; u < t.length; u++)
            if (
                ...
                if (
                    ((p.__ = r), (p.__b = r.__b + 1), null === (h = m[u]) || (h && p.key == h.key && p.type === h.type))
                )
                    m[u] = void 0;
                else
                    for (d = 0; d < _; d++) {
                ...
                (oe(e, p, (h = h || H), o, i, a, s, c, l),
                    ...
                    (d = p.ref) &&
                        h.ref != d &&
                        (g || (g = []), h.ref && g.push(h.ref, null, p), g.push(d, p.__c || f, p)),
                    null != f
                        ? (null == v && (v = f),
        ...
        for (r.__e = v, u = _; u--; )
            null != m[u] &&
                ('function' == typeof r.type && null != m[u].__e && m[u].__e == r.__d && (r.__d = G(n, u + 1)),
                se(m[u], m[u]));
    ...
    function oe(e, t, r, n, o, i, a, s, c) {
        ...
        try {
            ...
            ((t.__v = null),
                (c || null != i) && ((t.__e = s), (t.__h = !!c), (i[i.indexOf(s)] = null)),
                R.__e(e, t, r));
        }
    }
    function ie(e, t) {
        ...
        ke = {
            ...
            get: function (e) {
                ...
                if (
                    ...
                    (s && -1 == n.indexOf(s) && (delete be[n[n.length - 1]], n.splice(-1, 1, s)),
                            ...
                            switch ((e.prev = e.next)) {
                                ...
                                case 87:
                                    (r.categories &&
                                        ...
                                        (y = null),
                                        'native' == o &&
                                            ((_ = me.latestVersion()), (y = r.noCountryFlags || me.noCountryFlags())),
                        ...
                        for (;;)
                            switch ((e.prev = e.next)) {
                                case 0:
                                    return (
                                        (e.next = 2),
                                        Ie.search(r, { maxResults: 1, caller: 'getEmojiDataFromNative' })
                                    );
                                case 2:
                ...
                c(r, [
                    {
                        ...
                        value: function (e) {
                            ...
                            if (t) {
                                if (t.svg)
                                    return de('span', { class: 'flex', dangerouslySetInnerHTML: { __html: t.svg } });
            ...
            function o(e) {
                ...
                (a(this, o),
                    ...
                    l(n(s), 'handleClickOutside', function (e) {
                        ...
                        e.target != t &&
                            (s.state.showSkins && s.closeSkins(), s.props.onClickOutside && s.props.onClickOutside(e));
                    }),
                            ...
                            if (c.length) {
                                var l = b(this.state.pos, 2),
                                    ...
                                    h = (function () {
                                        ...
                                        if (-1 == u)
                                            return t.repeat || (!o && !a) || r.selectionStart != r.value.length
                                                ? null
                                                : [0, 0];
                                        if (n || o) {
                                            var e = c[u],
