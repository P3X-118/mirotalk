...
(function (window, undefined) {
    ...
    var extend = function (defaultRgx, extensions) {
            ...
            for (var k in defaultRgx) {
                mergedRgx[k] =
                    extraRgx[k] && extraRgx[k].length % 2 === 0 ? extraRgx[k].concat(defaultRgx[k]) : defaultRgx[k];
            }
            return mergedRgx;
        },
                                ...
                                if (q.length === 2) {
                                    ...
                                    if (typeof q[1] === TYPEOF.FUNCTION && !(q[1].exec && q[1].test)) {
                                        ...
                                        if (q.length == 3) {
                                            ...
                                            this[q[0]] = match
                                                ? q[3].apply(this, [match.replace(q[1], q[2])].concat(q.slice(4)))
                                                : undefined;
                                        }
                                    }
                                }
    ...
    var defaultRegexes = {
        ...
        device: [
            ...
            [
                MODEL,
                [VENDOR, strMapper, { OnePlus: ['203', '304', '403', '404', '413', '415'], '*': OPPO }],
                [TYPE, TABLET],
            ],
            ...
            switch (this.itemType) {
                ...
                case DEVICE:
                    ...
                    if (
                        ...
                        NAVIGATOR &&
                        typeof NAVIGATOR.standalone !== TYPEOF.UNDEFINED &&
