(!(function (e, t) {
        ...
        J = (e) => {
            ...
            for (const n in e)
                ((t = n),
                    ...
                    e.toast &&
                        ((t = n), _.includes(t) && a('The parameter "'.concat(t, '" is incompatible with toasts'))),
                    (t = n),
                    Z(t) && N(t, Z(t)));
            var t;
        };
    ...
    const d = () => t('.'.concat(p.loader)),
        ...
        ae = () =>
            w(document.body, p.shown) && !w(document.body, p['toast-shown']) && !w(document.body, p['no-backdrop']),
        re = () => g() && w(g(), p.toast);
    function se(e) {
                ...
                (function (e, t, n, o) {
                    ...
                    (A([e, t, n], p.styled),
                        o.confirmButtonColor &&
                            ((e.style.backgroundColor = o.confirmButtonColor), A(e, p['default-outline'])));
                    o.denyButtonColor && ((t.style.backgroundColor = o.denyButtonColor), A(t, p['default-outline']));
                    o.cancelButtonColor &&
                        ((n.style.backgroundColor = o.cancelButtonColor), A(n, p['default-outline']));
                })(i, a, r, o),
                o.reverseButtons &&
                    (o.toast
    ...
    const Me = (e, t) => {
        ...
        i &&
            ...
            (n = t.position) in p
                ? A(o, p[n])
                : (a('The "position" parameter is not valid, defaulting to "center"'), A(o, p.center)),
            (n = i),
    ...
    const De = ['input', 'file', 'range', 'select', 'radio', 'checkbox', 'textarea'],
            ...
            ((e.textContent = ''),
                t.iconHtml
                    ...
                    : 'success' === t.icon
                      ...
                      : 'error' === t.icon
                        ? y(e, Ye)
                        : ((n = { question: '?', warning: '!', info: 'i' }), y(e, Xe(n[t.icon]))));
        },
        Je = (e, t) => {
            if (t.iconColor) {
        ...
        et = (e, t) => {
            ...
            const o = g();
            (t.toast
                ? (pe(n, 'width', t.width), (o.style.width = '100%'), o.insertBefore(d(), s()))
                : pe(o, 'width', t.width),
            ...
            ((n.className = ''.concat(p.popup, ' ').concat(E(n) ? t.showClass.popup : '')), t.toast)
                ? (A([document.documentElement, document.body], p['toast-shown']), A(n, p.toast))
                : A(n, p.modal);
    ...
    const ht = () => {
        ...
        vt = (e) => {
            ...
            return (
                ...
                (n === o ||
                    !(fe(o) || 'INPUT' === n.tagName || 'TEXTAREA' === n.tagName || (fe($()) && $().contains(n))))
            );
        },
        yt = () => {
            var e;
                ...
                if ((o.stopKeydownPropagation && n.stopPropagation(), 'Enter' === n.key))
                    ((e = e),
                        ...
                        R(i.allowEnterKey) &&
                            ...
                            (['textarea', 'file'].includes(i.input) || (jt(), s.preventDefault())));
                else if ('Tab' === n.key) {
                    e = n;
                    var i = o;
                    var a = e.target,
    ...
    const mn = (l, u, d) =>
            new Promise((e, t) => {
                ...
                (Ot.swalPromiseResolve.set(l, e),
                    ...
                    (t = u),
                    (a = n),
                    L.innerParams.get(e).toast ? Gt(e, t, a) : (en(t), tn(t), nn(e, t, a)),
                    (o = l),
                    (e = T),
                    (t = d),
                    (i = n),
