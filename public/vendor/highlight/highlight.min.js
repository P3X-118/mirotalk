    ...
    const J = t,
        ...
        ne = (t) => {
            ...
            function f(e, t, i, r) {
                ...
                function b(e, n) {
                    return (
                        e.scope && 'string' == typeof e.scope && A.openNode(N.classNameAliases[e.scope] || e.scope),
                        e.beginScope &&
                            (e.beginScope._wrap
                                ? (g(S, N.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap), (S = ''))
    ...
    function ve(e) {
        ...
        const _ = [].concat(m, c.contains),
            ...
            N = {
                match: n.concat(
                    /\b/,
                    ((v = [...ye, 'super', 'import'].map((e) => e + '\\s*\\(')), n.concat('(?!', v.join('|'), ')')),
                    t,
                    n.lookahead(/\s*\(/)
                ),
    ...
    var Pe = Object.freeze({
        ...
        grmr_less: (e) => {
            const n = ae(e),
                ...
                c = { $pattern: /[a-z-]+/, keyword: 'and or not only', attribute: re.join(' ') },
        ...
        grmr_swift: (e) => {
            const n = { match: /\s+/, relevance: 0 },
                ...
                v = (e = '') => ({ begin: b(e, /"/), end: b(/"/, e), contains: [E(e), w(e)] }),
                k = {
                    className: 'string',
                ...
                S = { match: b(/`/, Fe, /`/) },
                C = [S, { className: 'variable', match: /\$\d+/ }, { className: 'variable', match: `\\$${$e}+` }],
                T = [
                    {
                        match: /(@|#(un)?)available/,
                        scope: 'keyword',
